    ...
    return SafeArea(
      child: Scaffold(
        ...
        body: RefreshIndicator(
          ...
          child: Obx(() {
            print(
                "Obx rebuild triggered. Loading: ${controller.isLoading.value}");
            print(
                "Filtered appointments count: ${controller.filteredAppointments.length}");
            print(
                "Total appointments count: ${controller.appointments.length}");
                  ...
                  SliverList(
                    delegate: SliverChildBuilderDelegate(
                      ...
                      (context, index) {
                        ...
                        print(
                            "Building appointment item #$index: ${appointment.id}");
